   ...
   try{
    ...
    return (
        <div>
            ...
            description="코드를 생성할 수 있는 페이지 입니다."
            icon={Code}
                             ...
                             render={({field})=>(
                                <FormItem className="col-span-12 lg:col-span-10">
                                        <FormControl className="m-0 p-0">
                                            ...
                                            disabled={isLoading}
                                            placeholder="리액트 훅을 이용한 간단한 토글 버튼을 만들어줘!"
                                            {...field}
                    ...
                    className="flex flex-col-reverse gap-y-4">
                        {messages.map((message)=>(
                           ...
                           <ReactMarkdown 
                            components={{
                                pre:({node,...props})=>{
                                    return <div className="overflow-auto w-full my2 bg-black/10 p-2 rounded-lg">
                                        <pre {...props} />
                                    </div>;
                                },
                                code:({node,...props})=>{
                                    return <code className="bg-black/10 rounded-lg p-"{...props} />;
                                }
                            }}
